...
Description	: Changes the ADS bibliographic style to one acceptable by CVN. Changes 
...
Intructions	: 
	...
	6. The output will be a file named:  "bibtex_cleaned4cvn.bib"
...
with open('bibtex_cleaned4cvn.bib', 'w') as bibfile:
